...
/* USER DEFINED TYPES */
const Task = new ASTEdge(ObjectType, new Sym("Task"), new ASTEdge(PropertyType, new Atom("name"), new ASTEdge(StringType, new Atom("write a compiler"))), new ASTEdge(PropertyType, new Atom("status"), new ASTEdge(StringType, new Atom("in progress"))));
