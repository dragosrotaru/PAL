...
export const Apply =
  ...
  async (ast: Form): Promise<Lang.AST> => {
    try {
      // GPT Call 1
      const response = await callGPT(ctx)(writer(ast[1]));
