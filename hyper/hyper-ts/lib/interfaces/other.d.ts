...
export interface IHyperGraph {
    ...
    search: (name: Name, options: HyperGraphSearchOptions) => Promise<Error | null | ID>;
...
export interface IHyperGraphRepository {
    ...
    persist: (entities: HyperEdge | HyperNode | (HyperEdge | HyperNode)[]) => Promise<Error | null>;
    retrieve: (ids: ID | ID[]) => Promise<Error | null | HyperEdge | HyperNode | (HyperEdge | HyperNode)[]>;
